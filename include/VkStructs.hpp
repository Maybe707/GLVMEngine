...
namespace GLVM::core
{
	...
	enum NextArrayAttachmentDescriptionCount {
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_0,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_1,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_2,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_3,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_4,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_5,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_6,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_7,
		ATTACHMENT_DESCRIPTION_NEXT_ARRAY_COUNT_8,
		ATTACHMENT_DESCRIPTION_ARRAY_MAX
	};

	enum NextArrayAttachmentReferenceCount {
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_0,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_1,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_2,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_3,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_4,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_5,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_6,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_7,
		ATTACHMENT_REFERENCE_NEXT_ARRAY_COUNT_8,
		ATTACHMENT_REFERENCE_ARRAY_MAX
	};

	enum NextArraySubpassDependencyNumber {
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_0,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_1,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_2,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_3,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_4,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_5,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_6,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_7,
		SUBPASS_DEPENDENCY_NEXT_ARRAY_COUNT_8,
		SUBPASS_DEPENDENCY_ARRAY_MAX
	};
