...
// 		.shininess = 128.0f * 0.078125f };
	...
	*ComponentManager->GetComponent<cm::directionalLight>(directionalLight0) = { .position = { 27.0f, 15.0f, 0.0f },
		.direction = { -5.0f, -1.0f, 0.0f}, .ambient = { 0.05f, 0.05f, 0.05f }, .diffuse = {0.8f, 0.8f, 0.8f},
		.specular = {1.0f, 1.0f, 1.0f}};
 	*ComponentManager->GetComponent<cm::transform>(directionalLight0) = { .tPosition = { 27.0f, 15.0f, 0.0f },
		.fScale = 0.3f };
...
//	ComponentManager->GetComponent<cm::texture>(pointLight1)->id = 0;
	*ComponentManager->GetComponent<cm::pointLight>(pointLight1)  = { .position = { -10.0f, 7.0f, 0.0f },
		.ambient = { 0.2f, 0.2f, 0.2f }, .diffuse = { 0.7f, 0.7f, 0.7f }, .specular = { 0.8f, 0.8f, 0.8f },
		.constant = 1.0f, .linear = 0.09f, .quadratic = 0.032f };
	*ComponentManager->GetComponent<cm::transform>(pointLight1) = { .tPosition = { -10.0f, 7.0f, 0.0f }, .fScale = 0.3f };
...
//	transformSpotLight0 = { .tPosition = transformPlayer.tPosition, .fScale = 0.3f };
	...
	*ComponentManager->GetComponent<cm::spotLight>(spotLight1) = { .position = { 12.0f, 10.0f, -3.0f },
		...
		.quadratic = 0.032f };
	*ComponentManager->GetComponent<cm::transform>(spotLight1) = { .tPosition = { 12.0f, 10.0f, -3.0f }, .fScale = 1.0f };
