...
//	ComponentManager->GetComponent<cm::texture>(uiWitch)->id = 1;
	*ComponentManager->GetComponent<cm::transform>(uiWitch) = { .tPosition = { 2.0f, 8.0f, 0.0f },
...
// 		.shininess = 128.0f * 0.078125f };
	...
	// *ComponentManager->GetComponent<cm::directionalLight>(directionalLight0) = { .position = { 20.0f, 12.0f, 0.0f },
	// 	.direction = { -5.0f, 0.0f, 0.0f}, .ambient = { 0.05f, 0.05f, 0.05f }, .diffuse = {0.8f, 0.8f, 0.8f},
	// 	.specular = {1.0f, 1.0f, 1.0f}};
 	// *ComponentManager->GetComponent<cm::transform>(directionalLight0) = { .tPosition = { 20.0f, 12.0f, 0.0f },
	// 	.fScale = 0.2f };
...
//	TextureManager->BindTexture(directionalLight1, materialDirectionalLight1.diffuseTextureID_);
	...
	// *ComponentManager->GetComponent<cm::pointLight>(pointLight0) = { .position = { 3.0f, 15.0f, 2.0f },
	// 	.ambient = { 0.2f, 0.2f, 0.2f }, .diffuse = { 0.5f, 0.5f, 0.5f }, .specular = { 1.0f, 1.0f, 1.0f },
	// 	.constant = 1.0f, .linear = 0.09f, .quadratic = 0.032f };
	// *ComponentManager->GetComponent<cm::transform>(pointLight0) = { .tPosition = { 3.0f, 15.0f, 2.0f }, .fScale = 0.2f };
...
// 	TextureManager->BindTexture(pointLight2, materialPointLight2->diffuseTextureID_);
	...
	*ComponentManager->GetComponent<cm::spotLight>(spotLight1) = { .position = { 5.0f, 18.0f, -8.0f },
		.direction = { 0.0f, -4.0f, 3.0f }, .cutOff = 32.5f, .outerCutOff = 37.5f, .ambient = { 0.05f, 0.05f, 0.05f },
		.diffuse = { 0.8f, 0.8f, 0.8f }, .specular = { 1.0f, 1.0f, 1.0f }, .constant = 1.0f, .linear = 0.09f,
		.quadratic = 0.032f };
	*ComponentManager->GetComponent<cm::transform>(spotLight1) = { .tPosition = { 5.0f, 18.0f, -8.0f }, .fScale = 0.5f };
