...
int main()
{
	...
	TexturePlayer.iWidth_ = 32; 
	TexturePlayer.iHeight_ = 32;
	TexturePlayer.u_iData_ = witch_dat;
    TexturePlayer.dat_length_ = witch_dat_len;
...
//     TransformWitch3.tPosition[2] = 1.0f;
//     TransformWitch3.fScale = 50.5f;
