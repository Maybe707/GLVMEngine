...
//	GLVM->LoadTextureData(TexturePlayer);
    ...
    TextureWitch.diffuseTextureID_ = 3;
	TextureWitch.specularTextureID_ = 4;
    TextureSystem->BindTexture(u_iWitch, TextureWitch.diffuseTextureID_);
//	TextureSystem->BindTexture(u_iWitch, TextureWitch.specularTextureID_);
...
//    GLVM::ECS::CColliderComponent& ColliderWitch1 = ComponentManager.GetComponent<GLVM::ECS::CColliderComponent>(u_iPlayer);
    ...
    TextureWitch2.diffuseTextureID_ = 3;
	TextureWitch2.specularTextureID_ = 4;
    ...
    TextureSystem->BindTexture(u_iWitch2, TextureWitch2.diffuseTextureID_);
//	TextureSystem->BindTexture(u_iWitch2, TextureWitch2.specularTextureID_);
...
//    std::cout << "WALL: " << ColliderWitch2.aColliders_Container_[0].bWall_Collision_ << std::endl;
	...
	textureLight0.specularTextureID_ = 2;
	TextureSystem->BindTexture(light0, textureLight0.diffuseTextureID_);
//	TextureSystem->BindTexture(light0, textureLight0.specularTextureID_);
