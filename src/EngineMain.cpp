...
// 	*ComponentManager->GetComponent<cm::transform>(uiWitch) = { .tPosition = { 0.0f, 0.0f, -10.0f },
...
// 	*ComponentManager->GetComponent<cm::transform>(uiWitch4) = { .tPosition = { -10.0f, 0.0f, 0.0f }, .fScale = 10.0f };
...
// 		.shininess = 128.0f * 0.078125f };
	...
	*ComponentManager->GetComponent<cm::directionalLight>(directionalLight0) = { .position = { 5.0f, 6.5f, 0.0f },
		.direction = { 0.0f, 0.1f, 0.0f}, .ambient = { 0.2f, 0.2f, 0.2f }, .diffuse = {5.5f, 0.5f, 0.5f},
		.specular = {0.3f, 0.3f, 0.3f}};
 	*ComponentManager->GetComponent<cm::transform>(directionalLight0) = { .tPosition = { 0.0f, 6.5f, 0.0f },
		.fScale = 0.3f };
	...
	*materialDirectionalLight0 = { .diffuseTextureID_ = 1, .specularTextureID_ = 1 };
	...
	ComponentManager->CreateComponent<cm::vertex, cm::pointLight, cm::transform, cm::texture>(pointLight1);
	ComponentManager->GetComponent<cm::texture>(pointLight1)->id = 0;
	*ComponentManager->GetComponent<cm::pointLight>(pointLight1)  = { .position = { 0.0f, 8.0f, 0.0f },
		.ambient = { 0.2f, 0.2f, 0.2f }, .diffuse = { 0.7f, 0.7f, 0.7f }, .specular = { 0.8f, 0.8f, 0.8f },
		.constant = 1.0f, .linear = 0.09f, .quadratic = 0.032f };
	*ComponentManager->GetComponent<cm::transform>(pointLight1) = { .tPosition = { 0.0f, 5.0f, 0.0f }, .fScale = 0.5f };
...
//	transformSpotLight0 = { .tPosition = transformPlayer.tPosition, .fScale = 0.3f };
	...
	ComponentManager->CreateComponent<cm::vertex, cm::spotLight, cm::transform>(spotLight1);
	*ComponentManager->GetComponent<cm::spotLight>(spotLight1) = { .position = { 5.0f, 10.0f, -14.0f },
		.direction = { 0.0f, 1.0f, 0.0f }, .cutOff = 12.5f, .outerCutOff = 17.5f, .ambient = { 0.2f, 0.2f, 0.2f },
		.diffuse = { 0.5f, 0.5f, 0.5f }, .specular = { 0.3f, 0.3f, 0.3f }, .constant = 5.0f, .linear = 0.09f,
		.quadratic = 0.032f };
	*ComponentManager->GetComponent<cm::transform>(spotLight1) = { .tPosition = { 1.0f, 10.0f, -14.0f }, .fScale = 0.3f };
