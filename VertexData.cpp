...
float vertices[] =
{
	...
	-0.5f,  0.5f, 0.0f,   0.0f, 1.0f,  // верхняя левая вершина
	0.5f,  0.5f, 0.0f,   kWidth_Offset, 1.0f,
...
float vertices3[] =
{
	...
	-0.5f, -0.5f, 0.0f,   kWidth_Offset * 2, 0.75f, // нижняя левая вершина
	-0.5f,  0.5f, 0.0f,   kWidth_Offset * 2, 1.0f,  // верхняя левая вершина
	0.5f,  0.5f, 0.0f,   1.0f, 1.0f,
...
float vertices6[] =
{
	...
	-0.5f, -0.5f, 0.0f,   kWidth_Offset * 2, 0.5f, // нижняя левая вершина
	-0.5f,  0.5f, 0.0f,   kWidth_Offset * 2, 0.75f,  // верхняя левая вершина
...
float vertices9[] =
{
	...
	-0.5f, -0.5f, 0.0f,   kWidth_Offset * 2, 0.25f, // нижняя левая вершина
	-0.5f,  0.5f, 0.0f,   kWidth_Offset * 2, 0.5f,  // верхняя левая вершина
...
float vertices12[] =
{
	...
	0.5f, -0.5f, 0.0f,   1.0f, 0.0f, // нижняя правая вершина
	-0.5f, -0.5f, 0.0f,   kWidth_Offset * 2, 0.0f, // нижняя левая вершина
	-0.5f,  0.5f, 0.0f,   kWidth_Offset * 2, 0.25f,  // верхняя левая вершина
	0.5f,  0.5f, 0.0f,   1.0f, 0.25f,
	-0.5f, -0.5f, 0.0f,   kWidth_Offset * 2, 0.0f
};
